...
CREATE UNIQUE INDEX FL_PJT_CODE_PJT_DIV_C_UINDEX
    ON FL_PJT_CODE (PJT_DIV_C);

CREATE UNIQUE INDEX FL_PJT_CODE_PJT_ORG_C_UINDEX
    ON FL_PJT_CODE (PJT_ORG_C);
...
CREATE SEQUENCE SEQ_FLPJT_C_NO
    INCREMENT BY 1 --증감숫자 1
    START WITH 1 --시작숫자 1
    MINVALUE 1 --최소값 1
    MAXVALUE 10000 --최대값 1000
    NOCYCLE; --순한하지않음


CREATE SEQUENCE SEQ_FLPJT_NO --시퀀스이름 EX_SEQ
    INCREMENT BY 1 --증감숫자 1
    START WITH 1 --시작숫자 1
    MINVALUE 1 --최소값 1
